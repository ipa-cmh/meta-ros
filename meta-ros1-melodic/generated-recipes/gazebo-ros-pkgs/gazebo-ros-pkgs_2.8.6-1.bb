...
# matches with: https://github.com/ros-gbp/gazebo_ros_pkgs-release/archive/release/melodic/gazebo_ros_pkgs/2.8.6-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/gazebo_ros_pkgs"
SRC_URI = "git://github.com/ros-gbp/gazebo_ros_pkgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "b4b3ce7d65f767900ae15aabef17f9dbee460fb7"
S = "${WORKDIR}/git"
