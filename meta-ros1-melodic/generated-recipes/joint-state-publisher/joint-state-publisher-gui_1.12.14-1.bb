...
# matches with: https://github.com/ros-gbp/joint_state_publisher-release/archive/release/melodic/joint_state_publisher_gui/1.12.14-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/joint_state_publisher_gui"
SRC_URI = "git://github.com/ros-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "b1253b153cca789d58128633597dc7cf0ab9b54d"
S = "${WORKDIR}/git"
