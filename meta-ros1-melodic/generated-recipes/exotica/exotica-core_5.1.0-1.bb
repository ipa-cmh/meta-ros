...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_msgpack} \
    ${ROS_UNRESOLVED_PLATFORM_PKG_zeromq3} \
    eigen-conversions \
    geometry-msgs \
    kdl-parser \
    libtinyxml2 \
...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_core/5.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/exotica_core"
SRC_URI = "git://github.com/ipab-slmc/exotica-release;${ROS_BRANCH};protocol=https"
SRCREV = "1326f6dc9b66b826e418e3facaa66cf32cd8d717"
S = "${WORKDIR}/git"
